...
class TestBoardManager:
    ...
    def test_board_string_board_creator(self):
        ...
        assert sut.current_cell.value.value == None
        ...
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((5,9))))
        ...
        sut.current_cell= WorkingCell(sut, sut.cell(Coordinates((9,9))))
    ...
    def test_board_lines(self):
        ...
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((2,1))))
        assert sut.current_cell.line == [8, 7, 4, 0, 0, 0, 0, 0, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((3,1))))
        assert sut.current_cell.line == [0, 0, 0, 0, 3, 0, 0, 9, 7]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((4,1))))
        assert sut.current_cell.line == [0, 6, 7, 9, 0, 0, 0, 5, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((5,1))))
        assert sut.current_cell.line == [9, 0, 0, 1, 0, 6, 0, 0, 8]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((6,1))))
        assert sut.current_cell.line == [0, 8, 0, 0, 0, 3, 1, 6, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((7,1))))
        assert sut.current_cell.line == [7, 2, 0, 0, 8, 0, 0, 0, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((8,1))))
        assert sut.current_cell.line == [0, 0, 0, 0, 0, 0, 9, 3, 5]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((9,1))))
    ...
    def test_board_columns(self):
        ...
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((1,2))))
        assert sut.current_cell.column == [0, 7, 0, 6, 0, 8, 2, 0, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((1,3))))
        assert sut.current_cell.column == [0, 4, 0, 7, 0, 0, 0, 0, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((1,4))))
        assert sut.current_cell.column == [6, 0, 0, 9, 1, 0, 0, 0, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((1,5))))
        assert sut.current_cell.column == [0, 0, 3, 0, 0, 0, 8, 0, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((1,6))))
        assert sut.current_cell.column == [0, 0, 0, 0, 6, 3, 0, 0, 1]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((1,7))))
        assert sut.current_cell.column == [0, 0, 0, 0, 0, 1, 0, 9, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((1,8))))
        assert sut.current_cell.column == [0, 0, 9, 5, 0, 6, 0, 3, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((1,9))))
    ...
    def test_board_blocks(self):
        ...
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((4,4))))
        assert sut.current_cell.block == [9, 0, 0, 1, 0, 6, 0, 0, 3]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((4,7))))
        assert sut.current_cell.block == [0, 5, 0, 0, 0, 8, 1, 6, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((7,1))))
        assert sut.current_cell.block == [7, 2, 0, 0, 0, 0, 0, 0, 0]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((7,4))))
        assert sut.current_cell.block == [0, 8, 0, 0, 0, 0, 0, 0, 1]
        sut.current_cell = WorkingCell(sut, sut.cell(Coordinates((7,7))))
